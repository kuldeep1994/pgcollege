...
class Migration_Install_course_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Course.Master.View',
			'description' => 'View Course Master',
			'status' => 'active',
		),
		array(
			'name' => 'Course.Master.Create',
			'description' => 'Create Course Master',
			'status' => 'active',
		),
		array(
			'name' => 'Course.Master.Edit',
			'description' => 'Edit Course Master',
			'status' => 'active',
		),
		array(
			'name' => 'Course.Master.Delete',
			'description' => 'Delete Course Master',
			'status' => 'active',
		),
    );
