...
{
    protected $permissionCreate = 'Address.Developer.Create';
    protected $permissionDelete = 'Address.Developer.Delete';
    protected $permissionEdit   = 'Address.Developer.Edit';
    protected $permissionView   = 'Address.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_address()) {
                ...
                redirect(SITE_AREA . '/developer/address');
            }
