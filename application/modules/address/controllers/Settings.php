...
{
    protected $permissionCreate = 'Address.Settings.Create';
    protected $permissionDelete = 'Address.Settings.Delete';
    protected $permissionEdit   = 'Address.Settings.Edit';
    protected $permissionView   = 'Address.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_address()) {
                ...
                redirect(SITE_AREA . '/settings/address');
            }
