...
{
    protected $permissionCreate = 'Address.Master.Create';
    protected $permissionDelete = 'Address.Master.Delete';
    protected $permissionEdit   = 'Address.Master.Edit';
    protected $permissionView   = 'Address.Master.View';
    ...
    public function index()
    {
        ...
        $records = $this->address_model->where('address_type','permanent')->find_all();
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_address()) {
                ...
                redirect(SITE_AREA . '/master/address');
            }
        ...
        $records = $this->address_model->getCountry();
    ...
    public function edit()
    {
        ...
        $state = $this->address_model->getState($data->country);
        Template::set('state', $state);

        $city = $this->address_model->getCity($data->state);
    ...
    public function getStateByCountryId()
    {
        ...
        $state = $this->address_model->getState($contry_id);
    ...
    public function getCityByStateId()
    {
        ...
        $city = $this->address_model->getCity($state_id);
