...
class Address_model extends BF_Model
{
	...
	protected $validation_rules 		= array(
		array(
			...
			'label' => 'lang:address_field_street_address',
			'rules' => 'required|max_length[255]',
		),
		array(
			'field' => 'city',
			'label' => 'lang:address_field_city',
			'rules' => 'required|max_length[50]',
		),
		array(
			'field' => 'state',
			'label' => 'lang:address_field_state',
			'rules' => 'required|max_length[50]',
		),
		array(
			'field' => 'zip_code',
			'label' => 'lang:address_field_zip_code',
			'rules' => 'required|max_length[30]',
		),
		array(
			'field' => 'country',
			'label' => 'lang:address_field_country',
			'rules' => 'required|max_length[30]',
		),
	);
