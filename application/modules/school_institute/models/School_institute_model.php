...
class School_institute_model extends BF_Model
{
    protected $table_name	= 'school_institute';
	protected $key			= 'id';
	...
	protected $validation_rules 		= array(
		array(
			...
			'label' => 'lang:school_institute_field_institute_name',
			'rules' => 'required|max_length[255]',
		),
		array(
			'field' => 'address',
			'label' => 'lang:school_institute_field_address',
			'rules' => 'max_length[255]',
		),
		array(
			'field' => 'city',
			'label' => 'lang:school_institute_field_city',
			'rules' => 'required|max_length[50]',
		),
		array(
			'field' => 'state',
			'label' => 'lang:school_institute_field_state',
			'rules' => 'required|max_length[30]',
		),
		array(
			'field' => 'zip_code',
			'label' => 'lang:school_institute_field_zip_code',
			'rules' => 'required|max_length[30]',
		),
		array(
			'field' => 'country',
			'label' => 'lang:school_institute_field_country',
			'rules' => 'required|max_length[30]',
		),
	);
