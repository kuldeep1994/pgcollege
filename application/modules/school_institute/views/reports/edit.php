...
<div class='admin-box'>
    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        ...
        <fieldset class='form-actions'>
            ...
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/reports/school_institute', lang('school_institute_cancel'), 'class="btn btn-warning"'); ?>
            
            <?php if ($this->auth->has_permission('School_Institute.Reports.Delete')) : ?>
                <?php echo lang('bf_or'); ?>
