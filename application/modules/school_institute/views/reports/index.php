...
$num_columns	= 9;
$can_delete	= $this->auth->has_permission('School_Institute.Reports.Delete');
$can_edit		= $this->auth->has_permission('School_Institute.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/school_institute/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->institute_name); ?></td>
				<?php else : ?>
