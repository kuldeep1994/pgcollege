...
$num_columns	= 9;
$can_delete	= $this->auth->has_permission('School_Institute.Content.Delete');
$can_edit		= $this->auth->has_permission('School_Institute.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/master/school_institute/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->institute_name); ?></td>
				<?php else : ?>
					<td><?php e($record->institute_name); ?></td>
				<?php endif; ?>
					<td><?php e($record->address); ?></td>
					<td><?php e($this->school_institute_model->getCityName($record->city)); ?></td>
					<td><?php e($this->school_institute_model->getStateName($record->state)); ?></td>
					<td><?php e($record->zip_code); ?></td>
					<td><?php e($this->school_institute_model->getCountryName($record->country)); ?></td>
