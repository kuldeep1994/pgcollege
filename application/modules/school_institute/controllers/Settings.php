...
{
    protected $permissionCreate = 'School_institute.Settings.Create';
    protected $permissionDelete = 'School_institute.Settings.Delete';
    protected $permissionEdit   = 'School_institute.Settings.Edit';
    protected $permissionView   = 'School_institute.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_school_institute()) {
                ...
                redirect(SITE_AREA . '/settings/school_institute');
            }
