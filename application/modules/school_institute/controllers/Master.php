...
{
    protected $permissionCreate = 'School_institute.Master.Create';
    protected $permissionDelete = 'School_institute.Master.Delete';
    protected $permissionEdit   = 'School_institute.Master.Edit';
    protected $permissionView   = 'School_institute.Master.View';
    ...
    public function index()
    {
        ...
        $records = $this->school_institute_model->where('deleted',0)->find_all();
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_school_institute()) {
                ...
                redirect(SITE_AREA . '/master/school_institute');
            }
        ...
        $records = $this->school_institute_model->getCountry();
    ...
    public function edit()
    {
        ...
        $data = $this->school_institute_model->find($id);
        Template::set('school_institute', $data);

        $records = $this->school_institute_model->getCountry();
        Template::set('countries', $records);

        $state = $this->school_institute_model->getState($data->country);
        Template::set('state', $state);

        $city = $this->school_institute_model->getCity($data->state);
    ...
    public function getStateByCountryId()
    {
        ...
        $state = $this->school_institute_model->getState($contry_id);
    ...
    public function getCityByStateId()
    {
        ...
        $city = $this->school_institute_model->getCity($state_id);
