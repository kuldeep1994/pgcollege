...
{
    protected $permissionCreate = 'School_institute.Reports.Create';
    protected $permissionDelete = 'School_institute.Reports.Delete';
    protected $permissionEdit   = 'School_institute.Reports.Edit';
    protected $permissionView   = 'School_institute.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_school_institute()) {
                ...
                redirect(SITE_AREA . '/reports/school_institute');
            }
