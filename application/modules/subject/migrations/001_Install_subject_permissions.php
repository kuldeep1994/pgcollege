...
class Migration_Install_subject_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Subject.Master.View',
			'description' => 'View Subject Master',
			'status' => 'active',
		),
		array(
			'name' => 'Subject.Master.Create',
			'description' => 'Create Subject Master',
			'status' => 'active',
		),
		array(
			'name' => 'Subject.Master.Edit',
			'description' => 'Edit Subject Master',
			'status' => 'active',
		),
		array(
			'name' => 'Subject.Master.Delete',
			'description' => 'Delete Subject Master',
			'status' => 'active',
		),
    );
