...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Local_Address.Settings.Delete');
$can_edit		= $this->auth->has_permission('Local_Address.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/local_address/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->street_address); ?></td>
				<?php else : ?>
