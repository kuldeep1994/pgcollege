...
{
    protected $permissionCreate = 'Local_address.Reports.Create';
    protected $permissionDelete = 'Local_address.Reports.Delete';
    protected $permissionEdit   = 'Local_address.Reports.Edit';
    protected $permissionView   = 'Local_address.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_local_address()) {
                ...
                redirect(SITE_AREA . '/reports/local_address');
            }
