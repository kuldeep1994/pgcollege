...
{
    protected $permissionCreate = 'Local_address.Settings.Create';
    protected $permissionDelete = 'Local_address.Settings.Delete';
    protected $permissionEdit   = 'Local_address.Settings.Edit';
    protected $permissionView   = 'Local_address.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_local_address()) {
                ...
                redirect(SITE_AREA . '/settings/local_address');
            }
