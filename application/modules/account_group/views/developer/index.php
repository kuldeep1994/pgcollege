...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Account_Group.Developer.Delete');
$can_edit		= $this->auth->has_permission('Account_Group.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/account_group/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->group_name); ?></td>
				<?php else : ?>
					<td><?php e($record->group_name); ?></td>
				<?php endif; ?>
					<td><?php e($record->description); ?></td>
					<td><?php e($record->parent_group); ?></td>
