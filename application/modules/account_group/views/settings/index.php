...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Account_Group.Settings.Delete');
$can_edit		= $this->auth->has_permission('Account_Group.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/account_group/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->group_name); ?></td>
				<?php else : ?>
