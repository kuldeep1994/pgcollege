...
class Migration_Install_account_group_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Account_group.Accounting.View',
			'description' => 'View Account_group Content',
			'status' => 'active',
		),
		array(
			'name' => 'Account_group.Accounting.Create',
			'description' => 'Create Account_group Content',
			'status' => 'active',
		),
		array(
			'name' => 'Account_group.Accounting.Edit',
			'description' => 'Edit Account_group Content',
			'status' => 'active',
		),
		array(
			'name' => 'Account_group.Accounting.Delete',
			'description' => 'Delete Account_group Content',
			'status' => 'active',
		),
		array(
