...
{
    protected $permissionCreate = 'Account_group.Master.Create';
    protected $permissionDelete = 'Account_group.Master.Delete';
    protected $permissionEdit   = 'Account_group.Master.Edit';
    protected $permissionView   = 'Account_group.Master.View';
    ...
    public function index()
    {
        ...
        $records = $this->account_group_model->where('deleted',0)->find_all();
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_account_group()) {
                ...
                redirect(SITE_AREA . '/master/account_group');
            }
        ...
        Template::set('group', $this->account_group_model->getParentGroup());
    ...
    public function edit()
    {
        ...
        $data = $this->account_group_model->find($id);
        Template::set('account_group', $data);
