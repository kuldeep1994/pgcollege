...
{
    protected $permissionCreate = 'Account_group.Reports.Create';
    protected $permissionDelete = 'Account_group.Reports.Delete';
    protected $permissionEdit   = 'Account_group.Reports.Edit';
    protected $permissionView   = 'Account_group.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_account_group()) {
                ...
                redirect(SITE_AREA . '/reports/account_group');
            }
