...
{
    protected $permissionCreate = 'Account_group.Developer.Create';
    protected $permissionDelete = 'Account_group.Developer.Delete';
    protected $permissionEdit   = 'Account_group.Developer.Edit';
    protected $permissionView   = 'Account_group.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_account_group()) {
                ...
                redirect(SITE_AREA . '/developer/account_group');
            }
