...
$num_columns	= 12;
$can_delete	= $this->auth->has_permission('Qualification.Content.Delete');
$can_edit		= $this->auth->has_permission('Qualification.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/qualification/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->class); ?></td>
				<?php else : ?>
