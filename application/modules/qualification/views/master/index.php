...
$num_columns	= 12;
$can_delete	= $this->auth->has_permission('Qualification.Master.Delete');
$can_edit		= $this->auth->has_permission('Qualification.Master.Edit');
		...
		<table class='table table-striped'>
			<thead>
				<tr>
					...
					<th><?php echo lang('qualification_field_roll_no'); ?></th>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/master/qualification/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->class); ?></td>
				<?php else : ?>
