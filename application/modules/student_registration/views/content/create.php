    ...
    <?php echo form_open_multipart($this->uri->uri_string(), 'class="form"'); ?>
        ...
        <div class="span4">
            ...
            <?php // Change the values in this array to populate your dropdown as required
                ...
                echo form_dropdown(array('name' => 'nationality', 'required' => 'required'), $nationality_options, set_value('nationality', isset($address->nationality) ? $address->nationality : ''), lang('student_registration_field_nationality') . lang('bf_form_label_required'));
            ?>
            ...
            <?php // Change the values in this array to populate your dropdown as required
                ...
                echo form_dropdown(array('name' => 'relegion', 'required' => 'required'), $relegion_options, set_value('relegion', isset($address->relegion) ? $address->relegion : ''), lang('student_registration_field_relegion') . lang('bf_form_label_required'));
            ?>
        ...
        <div class="span4">
            ...
            <label class="control-label"><?php echo lang('student_registration_field_country'); ?><span class="required">*</span></label>
                <div class="controls">
                    <select name="country_permanent" required="required" id="country_permanent">
                        <?php foreach($countries as $row) { if($row->id=='101'){ 
                            $select = 'selected' ;
                        }
                        else{
                            $select = '';
                        ...
                        ?>
                            <option <?php echo $select . set_value('country_permanent', isset($address->country) ? $address->country : '')?> value="<?php echo $row->id?>"><?php echo $row->name ?></option>
                        <?php   }  ?>
                    </select>
                </div>
            </div>
            ...
            <div class="control-group">
            <label class="control-label"><?php echo lang('student_registration_field_state'); ?><span class="required">*</span></label>
                <div class="controls">
                    <select name="state_permanent" required="required" id="state_permanent">
                        <?php foreach($state as $row) { if($row->id=='38'){ 
                            $select = 'selected' ;
                        }
                        else{
                            $select = '';
                        ...
                        ?>
                            <option <?php echo $select . set_value('state_permanent', isset($address->state) ? $address->state : '')?> value="<?php echo $row->id?>"><?php echo $row->name ?></option>
                        <?php   }  ?>
                    </select>
                </div>
            </div>
            ...
            <div class="control-group">
            <label class="control-label"><?php echo lang('student_registration_field_city'); ?><span class="required">*</span></label>
                <div class="controls">
                    <select name="city_permanent" required="required" id="city_permanent">
                        <?php foreach($city as $row) { if($row->id=='4593'){ 
                            $select = 'selected' ;
                        }
                        else{
                            $select = '';
                        ...
                        ?>
                            <option <?php echo $select . set_value('city_permanent', isset($address->city) ? $address->city : '')?> value="<?php echo $row->id?>"><?php echo $row->name ?></option>
                        <?php   }  ?>
                    </select>
                </div>
            </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <?php 
                       ...
                       echo form_dropdown(array('name' => 'class[]', 'id'=>'class', 'required' => 'required','class'=>'custom_select'), $options, set_value('class', isset($student_registration->class) ? $student_registration->class : ''));
                    ?>
                    </td>
                    <td>
                    <?php 
                       ...
                       echo form_dropdown(array('name' => 'stream[]', 'required' => 'required','class'=>'custom_select'), $options, set_value('stream', isset($student_registration->stream) ? $student_registration->stream : ''));
                    ?>
                    </td>
                    <td>
                    <?php 
                    ...
                    <?php 
                        ...
                        echo form_dropdown(array('name' => 'board[]', 'id'=>'board', 'required' => 'required','class'=>'custom_select'), $board_options, set_value('board', isset($student_registration->board) ? $student_registration->board : ''));
                    ?>
                    </td>
                    <td><input id='roll_no' class="custom_input" type='text' required='required' name='roll_no[]'  value="<?php echo set_value('roll_no', isset($student_registration->roll_no) ? $student_registration->roll_no : ''); ?>" /></td>
                    <td><input id='total_marks' class="custom_input" type='text' required='required' name='total_marks[]'  value="<?php echo set_value('total_marks', isset($student_registration->total_marks) ? $student_registration->total_marks : ''); ?>" /></td>
                    <td><input id='obtained_mark' class="custom_input" type='text' required='required' name='obtained_mark[]'  value="<?php echo set_value('obtained_mark', isset($student_registration->obtained_mark) ? $student_registration->obtained_mark : ''); ?>" /></td>
                    <td><input id='percentage' class="custom_input" type='text' required='required' name='percentage[]'  value="<?php echo set_value('percentage', isset($student_registration->percentage) ? $student_registration->percentage : ''); ?>" /></td>
                    <td><input id='pass_year' class="custom_input" type='text' required='required' name='pass_year[]'  value="<?php echo set_value('pass_year', isset($student_registration->pass_year) ? $student_registration->pass_year : ''); ?>" /></td>
                    </tr>
