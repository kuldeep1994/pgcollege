    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <?php // Change the values in this array to populate your dropdown as required
                ...
                $options = array('' => 'Please Select Account Group');
        ...
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('account_head_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/content/account_head', lang('account_head_cancel'), 'class="btn btn-warning"'); ?>
