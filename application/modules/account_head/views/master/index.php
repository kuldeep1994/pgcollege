...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('Account_Head.Content.Delete');
$can_edit		= $this->auth->has_permission('Account_Head.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/master/account_head/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->head_name); ?></td>
				<?php else : ?>
					<td><?php e($record->head_name); ?></td>
				<?php endif; ?>
					<td><?php e($this->account_head_model->getAccountGroupName($record->account_group)); ?></td>
